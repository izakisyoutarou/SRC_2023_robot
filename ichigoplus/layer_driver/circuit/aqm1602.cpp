...
void Aqm1602::sendString(const char data[WORD]){
	int j=0;
...
void Aqm1602::sendChar(const char data){
	str[num][0]=0x40;
	str[num][1]=data;
...
void Aqm1602::setCursor(const char x,const char y){
	this->x=x;
	this->y=y;
	str[num][0]=0x00;
