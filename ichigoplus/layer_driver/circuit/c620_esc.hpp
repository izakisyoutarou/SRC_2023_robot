...
class C620ESC : public RobomasterESC{
public:
	C620ESC(const int number, const int period_ms=2, const bool count=true, const bool rpm=false, const bool torque=false);
...
private:
    ...
    public:
        Encoder(C620ESC &c620ESC) : c620ESC(c620ESC){};
        int setup() override;
    	void cycle() override;
    ...
    public:
        Motor(C620ESC &c620ESC) : c620ESC(c620ESC){};
        int setup()override;
	    void cycle()override;
