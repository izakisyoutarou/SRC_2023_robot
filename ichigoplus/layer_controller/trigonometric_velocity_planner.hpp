...
/*******************************************
 * trigonometric_velocity_planner ver1.1 2021/02/05
 * This program is generate curved acceleration for velocity
 *
 * [Dependency]
 *
 * [Note]
 ...
 *
 * [Change history]
 * ver1.1 2021/02/05 fix a bug that not work well when running vel() in continuous.
 * ver1.0 2020/11/28 refactoring
 * ver0.2 2020/09/18 refactoring
 * ver0.1 2020/08/31 The first version
 ******************************************/
...
class TrigonometoricVelocityPlanner: public VelocityPlanner {
public:
	TrigonometoricVelocityPlanner(Limit_t limit = Limit_t(0.f, 0.f, 0.f, 0.f)): velPlanner(limit), posPlanner(limit) {}
	void cycle() override;
...
// 利便性のためエイリアス及びusing宣言
using trigonometoric_velocity_planner::TrigonometoricVelocityPlanner;
using TrigonometoricVelocityPlannerLimit = trigonometoric_velocity_planner::Limit_t;
